...
async function starts() {
   ...
   if (cr == "") {
    ...
    lolteam.on('chat-update', async(lol) => {
        try {
            ...
            global.prefix
	    const ownerNumber = ["5511910622412@s.whatsapp.net"] // owner number ubah aja
 ...
 if (isCmd) cmdadd()
		...
		case 'dare':
		if (!isRegistered) return reply(ind.noregis())
		const dare =['Envie uma mensagem para o seu ex e diga "Eu ainda gosto de você ',' ligue para Crush / namorada agora e ss para o jogador ',' papai para um membro do grupo ',' Diga" VOCÊ É TÃO BONITA E NÃO FOI AMIGÁVEL " para rapazes ',' ss recente chamada Whatsapp ',' soltar emoji "🦄 ??" toda vez que digitar no gc / pc por 1 dia ',' enviar uma nota de voz dizendo posso te ligar, baby? ',' largar uma música / quote quote, continue a tag o membro apropriado faça uma citação ',' use uma foto sule até 3 dias ',' digite no idioma local 24 horas ',' mude o nome para "I'm a cute child, luna" por 5 horas "," bate-papo com os contatos e o pedido de acordo com sua% bateria, continue dizendo a ele tive sorte em ter você "," prank chat ex e diga eu te amo, pgn de volta "," grava um audio gemendo! ',' diga "eu tenho uma queda por você, você quer ser minha namorada ou não?" caiu aqui ',' indique o tipo de sua namorada! ',' tire / poste fotos de namorada / paquera ',' gritou gajelas e envie usando vn aqui ',' paparique sua cara e envie para um de seus amigos ',' ki borda de sua foto com uma legenda, eu sou uma criança adotada ',' gritou com palavras ásperas enquanto vn então a enviou aqui ',' gritou "anjimm gabutt anjimmm" na frente de sua casa ',' mude o nome para "BOWO" por 24 horas ',' Finja possuído, por exemplo: posse de maung, posse de gafanhoto, posse de geladeira, etc. ']
